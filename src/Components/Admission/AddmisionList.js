...
const AdmissionList = () => {
    ...
    return (
        <div className="containerAdmission">
               ...
               <img src="/images/course_6.jpg"  className="mediaImage"    alt=""/>
                ...
                <div style={{height:"100%"}}>
                    <div className="addHeaderTit1" >
                       ...
                       <p className="addTit1" style={{fontSize:"1.25rem"}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. At itaque dolore libero corrupti! Itaque, delectus?</p>
                       ...
                       Accomplished Application Form</p>
                       </div> 
                       <div className="addFlex">
                       <CheckIcon
                       style={{color:"green",fontSize:"1.5rem"}}
                       ...
                       />
                       <p className="checkTitle"> 
                       Certificate of Good Moral Characte</p>
                       </div> 
                       <div className="addFlex">
                       <CheckIcon
                       style={{color:"green",fontSize:"1.5rem"}}
            ...
            {/*     Second   Item    */}
            <div className="admisionFlexBox" style={{paddingTop:"100px"}}>
            <div style={{height:"100%"}}>
